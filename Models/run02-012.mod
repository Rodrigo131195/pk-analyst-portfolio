...
$TABLE ID TIME TAD DV MDV EVID PRED IPRED IWRES CWRES CMTX VISIT WT ADA MTX ONEHEADER NOPRINT FILE=sdtab02-012
$TABLE ID CL CLX KM VMAX X V2 V3 V4 V5 Q23 KA KADA ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7 ONEHEADER NOPRINT FILE=patab02-012
