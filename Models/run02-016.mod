...
$PROBLEM 
;; 2. Description: MM + groups gow + Delay
;; x1. Author: munoz01r
...
$TABLE ID TIME TAD DV MDV EVID PRED IPRED IWRES CWRES CMTX VISIT WT ADA MTX ADA_G ONEHEADER NOPRINT FILE=sdtab02-016
$TABLE ID CL CLX KM VMAX X V2 V3 V4 V5 Q23 KA KADA ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7 ETA8 ONEHEADER NOPRINT FILE=patab02-016
